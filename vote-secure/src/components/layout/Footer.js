    ...
    <footer className="bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Links */}
          <div className="col-span-1 md:col-span-1">
            <h3 className="text-sm font-semibold text-gray-500 tracking-wider uppercase dark:text-gray-300">
              Solutions
            </h3>
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-8">
          <p className="text-base text-gray-400 text-center">
            &copy; {new Date().getFullYear()} VoteSecure, Inc. All rights reserved.
            <p className="text-lg font-bold text-center mt-2 bg-gradient-to-r from-black via-yellow-400 to-yellow-500 bg-clip-text text-transparent drop-shadow-lg">
              Created by TheRealSaitama
            </p>
          </p>
        </div>
      </div>
